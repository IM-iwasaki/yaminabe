...
abstract class CharacterBase : NetworkBehaviour {
    //現在の体力
    [SerializeField] protected int HP{ get; private set; }
    //最大の体力
    [SerializeField] protected int maxHP { get; private set; }
    //基礎攻撃力
    [SerializeField] protected int Attack { get; private set; }
    //移動速度
    [SerializeField] protected int moveSpeed { get; private set; }
